...
// We needthese to support passing in a transport taht has custom TLS configuration
// There are not exposed in the docker/registry package so we need to copy them here
